...
def create_test_drivers():
    """Create test drivers with proper Neo4j relationships"""
    ...
    # Test domains  
    domains = ["Banking", "Insurance", "E-commerce", "Software"]
...
def create_test_objects_with_specific_drivers():
    """Create test objects with SPECIFIC driver selections (not ALL)"""
    print("🏗️  Creating test objects with specific drivers...")
    
    test_objects = [
        # Objects with Finance sector - should be affected when Finance is deleted
        {
            "sector": ["Finance"],  # SPECIFIC sector, not ALL
            "domain": ["Banking"],
            "country": ["USA"],
        ...
        # Objects with Healthcare sector - should be affected when Healthcare is deleted
        {
            "sector": ["Healthcare"],  # SPECIFIC sector, not ALL
            "domain": ["ALL"],
            "country": ["USA"],
            "objectClarifier": "None",
            "being": "Process",
        ...
        # Objects with Retail sector - should be affected when Retail is deleted
        {
            "sector": ["Retail"],  # SPECIFIC sector, not ALL
            "domain": ["E-commerce"],
            "country": ["USA"],
            "objectClarifier": "None",
            "being": "Process",
        ...
        # Objects with Technology sector - should be affected when Technology is deleted
        {
            "sector": ["Technology"],  # SPECIFIC sector, not ALL
            "domain": ["Software"],
            "country": ["USA"],
            "objectClarifier": "None",
            "being": "Process",
...
def main():
    print("🚀 Setting up final test environment with proper driver selections...")
    print("=" * 70)
    ...
    # Step 3: Create test objects with SPECIFIC driver selections
    created_objects = create_test_objects_with_specific_drivers()
    ...
    print("\n" + "=" * 70)
    print("✅ Final test environment setup complete!")
    print(f"📊 Created {len(created_objects)} objects")
    print("\n🎯 Test scenarios (these will now work correctly):")
    ...
    print("5. Objects with 'ALL' sectors should NOT be affected")
