...
def test_nonprofit_delete():
    """Test deleting the Non-Profit sector"""
    
    print("🧪 Testing delete logic for sector: Non-Profit")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print(f"🗑️  Testing delete of sector: Non-Profit")
    
    # Test the delete endpoint
    try:
        response = requests.delete("http://localhost:8000/api/v1/drivers/sectors/Non-Profit")
