...
export const VariablesCustomSortModal: React.FC<VariablesCustomSortModalProps> = ({
  ...
  // Get available columns for Variables custom sort (Sector, Domain, Country, Part, Group, Variable)
  const availableColumns = columns.filter(col => 
    col.sortable && ['sector', 'domain', 'country', 'part', 'group', 'variable'].includes(col.key)
  );
      ...
      <div className="bg-ag-dark-surface rounded-lg border border-ag-dark-border p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-6 p-4 bg-ag-dark-bg rounded-lg border border-ag-dark-border">
          <p className="text-sm text-ag-dark-text-secondary">
            ...
            the second will be the secondary sort, and so on. Available columns: Sector, Domain, Country, Part, Group, Variable.
          </p>
        </div>
